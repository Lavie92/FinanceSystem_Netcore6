    ...
    public class ReportController : Controller
    {
        ...
        public async Task<IActionResult> GetData()
        {
            ...
            var data = await _context.Transactions
             ...
             .Where(t => t.CreateDate != null && t.Amount != null && t.Income != null && t.Wallet.UserId == id)
        ...
        public async Task<IActionResult> GetDataCategory()
        {
            ...
            var data = await _context.Transactions.Where(x => x.WalletId == x.WalletId && x.Wallet.UserId == id && x.Income == false)
