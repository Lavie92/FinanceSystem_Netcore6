...
namespace FinanceSystem.Migrations
{
    ...
    [Migration("20230605235741_update one has one premium and user")]
    partial class updateonehasonepremiumanduser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceSystem.Models.Premium", b =>
                {
            ...
            modelBuilder.Entity("FinanceSystem.Models.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinanceSystem.Areas.Identity.Data.FinanceSystemUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("FinanceSystemUser");
                });
            ...
            modelBuilder.Entity("FinanceSystem.Models.Premium", b =>
                {
                    b.HasOne("FinanceSystem.Areas.Identity.Data.FinanceSystemUser", "User")
                        .WithOne("Premium")
                        .HasForeignKey("FinanceSystem.Models.Premium", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinanceSystem.Models.Subscription", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("FinanceSystem.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("FinanceSystem.Models.Plan", "Plan")
                        .WithMany("Transactions")
